  ...
  return (
    <div className="container space-y-10">
      <div>
        ...
        <div>
          <div className="text-sm">KOMPLEK PONPES AL-ABBASIYAH</div>
          <div className="text-sm">
            Jerua Desa Montong Beter Kec. Sakra Barat
          </div>
        </div>
      </div>
      <div className="flex justify-center relative">
        <div className="w-3/4 md:w-1/2 rounded-xl border-2 border-white map-title">
      ...
      <a
        ...
        target="_blank"
        className="map-title bg-pink-700 w-auto text-sm px-4 py-3 rounded-md bottom-0 mb-3 translate-x-0 hover:translate-x-4"
